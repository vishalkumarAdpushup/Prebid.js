...
const serverString =
	'/AdWebService/ads?section=__SECTION__&pos=__POSITION__&ref=__REFERRER__&blockAnimation=__BLOCK_ANIMATION__&siteId=__SITE_ID__' +
...
var adpushupAdapter = function adpushupAdapter() {
	...
	function _callBids(params) {
		...
		utils._each(bids, function(bid) {
			...
			paramObj.REFERRER = bid.params.referrer;
